-- 운영 DB와 관계없는 로컬 MQTT 부하 실험용 캠퍼스·공간·노드 1,000개를 준비한다.
...
-- 반복 실행해도 같은 node/space를 재사용하도록 1,000개의 fixture 노드를 idempotent하게 만든다.
...
BEGIN
    ...
    DECLARE stage_suffix CHAR(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
    ...
    WHILE node_index <= 1000 DO
        SET stage_suffix = LPAD(node_index, 4, '0');
